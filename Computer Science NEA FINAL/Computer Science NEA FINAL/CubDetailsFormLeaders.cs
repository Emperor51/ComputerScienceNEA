...
{
    public partial class CubDetailsFormLeaders : Form
    {
        ...
        public CubDetailsFormLeaders()
        {
            InitializeComponent();
            
        }

        private void CubDetailsFormLeaders_Load(object sender, EventArgs e)
        {
            try
            {
                m_dbConnection.Open();
...
WHERE e.name = 'Cub'";
        ...
        private void Save_Button_Click(object sender, EventArgs e)
        {
            try
            {
                _sqLiteCommandBuilder = new SQLiteCommandBuilder(_sqLiteDataAdapter);
                _sqLiteDataAdapter.Update(_dataTable);
                MessageBox.Show("Information updated");
            }
            catch
            {
                MessageBox.Show("Error updating table", "Error");
            }
        }
